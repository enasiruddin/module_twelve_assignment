            ...
            if (screenWidth >600)
              Row(
                children: [
                  TextButton(
                    onPressed: () {},
                    child: Text(viewModel.model.menuText[0], style: const TextStyle(color: Colors.black)),
                  ),
                  const SizedBox(width: 20),
                  TextButton(
                    onPressed: () {},
                    child: Text(viewModel.model.menuText[1], style: const TextStyle(color: Colors.black)),
                  ),
                ],
              ),
          ],
